...
Module TeamspeakEngine
    ...
    Public Sub StartupSettings()
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(142, 68, 173)
        ...
        End If
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(39, 174, 96)
    End Sub

    Public Sub CheckConnection()
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(142, 68, 173)
        strMnuIpDisplay = My.Forms.frmTeamspeakMain.mnuIpDisplay.Text
            ...
            If (intOnlineTest0 >= 1) = True Then
                If (intOnlineTest1 >= 1) = True Then
                    ...
                    Catch exUpdate As Exception
                        ...
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Warning
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Cant Connect Online"
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Can't connect online to check for updates."
                        My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                        strDiagnostics0 = exErrorData.Message
                        DiagnosticsLoad()
                    End Try
                    If Operators.CompareString(strRawData, String.Empty, False) = 0 Then
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Unable to check for updates"
                        My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "There was an error connecting to your server."
                        My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                    Else
                        If strRawData.Contains(strVersion) = True Then
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Up to date"
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Wow you have the latest version of Teamspeak Assistant Tool :-)."
                            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                        Else
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Update Found"
                            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Wow there is an update for Teamspeak Assistant Tool and we recommend you to download it as it may contain new features or bug fixes."
                            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                        End If
                    End If
                Else
    ...
    Public Sub StartTray()
        ...
        If intStartTray = 1 Then
            My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(211, 84, 0)
            My.Forms.frmTeamspeakMain.mnuStartInTray.Enabled = False
            My.Forms.frmTeamspeakMain.WindowState = FormWindowState.Minimized
            My.Forms.frmTeamspeakMain.ShowInTaskbar = False
        End If
        If intStartTray > 1 Then
            intErrorMessage = 47
            ErrorMessage()
    ...
    Public Sub MessageInfo()
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(22, 160, 133)
    ...
    Public Sub CleanStartUp()
        ...
        If RuntimeHelpers.GetObjectValue(My.Computer.Registry.CurrentUser.OpenSubKey("SOFTWARE\Microsoft\Windows\CurrentVersion\Run", True).GetValue(Application.ProductName)) Is Nothing Then
            My.Forms.frmTeamspeakMain.mnuDisableStartUp.Enabled = False
        Else
            My.Forms.frmTeamspeakMain.mnuEnableStartUp.Enabled = False
        End If
        If My.User.IsInRole(BuiltInRole.Administrator) Then
            My.Forms.frmTeamspeakMain.mnuAdmin.Enabled = False
            My.Forms.frmTeamspeakMain.cmnuAdmin.Enabled = False
            My.Forms.frmTeamspeakMain.cmnuAdminTray.Enabled = False
        End If
        If intAccount = 0 Then
            My.Forms.frmTeamspeakMain.mnuTimerAdjustments.Enabled = False
            My.Forms.frmTeamspeakMain.mnuDiagnosticViewer.Enabled = False
        ...
        End If
        If intAccount > 0 Then
            My.Forms.frmTeamspeakMain.mnuTimerAdjustments.Enabled = True
            My.Forms.frmTeamspeakMain.mnuDiagnosticViewer.Enabled = True
        ...
        If intControl = 0 Then
            My.Forms.frmTeamspeakMain.mnuServiceRestart.Enabled = False
            My.Forms.frmTeamspeakMain.mnuServiceStart.Enabled = False
            My.Forms.frmTeamspeakMain.mnuServiceStop.Enabled = False
        End If
        If intControl = 1 Then
            My.Forms.frmTeamspeakMain.mnuServiceRestart.Enabled = True
            My.Forms.frmTeamspeakMain.mnuServiceStart.Enabled = True
            My.Forms.frmTeamspeakMain.mnuServiceStop.Enabled = True
        End If
        If intControl = 2 Then
            ...
            My.Forms.frmTeamspeakMain.mnuServiceStop.Enabled = True
        End If
        My.Forms.frmTeamspeakMain.lblEasterEgg2.Text = ""
        My.Forms.frmTeamspeakMain.lblEasterEgg3.Text = ""
        intUserTime = 5
        intErrorCountStartUp = 2
        strVersion = "4.5.28.4"
        My.Forms.frmTeamspeakMain.mnuVersion.Text = "V." + strVersion
        My.Forms.frmTeamspeakMain.nicTeamspeak.Text = "Dynamic DNS for Teamspeak DNS"
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(39, 174, 96)
    End Sub
    ...
    Public Sub ServiceStatus()
        If My.User.IsInRole(BuiltInRole.Administrator) Then
            ...
            Try
                ...
                If svcTeamspeak.Status.Equals(ServiceControllerStatus.Stopped) Then
                    My.Forms.frmTeamspeakMain.mnuServiceStop.Enabled = False
                    My.Forms.frmTeamspeakMain.mnuServiceStart.Enabled = True
                End If
                If svcTeamspeak.Status.Equals(ServiceControllerStatus.Running) Then
                    My.Forms.frmTeamspeakMain.mnuServiceStart.Enabled = False
                    My.Forms.frmTeamspeakMain.mnuServiceStop.Enabled = True
                End If
    ...
    Public Sub ErrorMessage()
        If intErrorMessage = 1 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not get a valid file path from DNSSettings in settings."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount1 += 1
            If intErrorCount1 <= 3 Then
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(192, 57, 43)
        ...
        If intErrorMessage = 2 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You have mess with settings file and have not correctly changed it to represent valid data."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
        ...
        If intErrorMessage = 3 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not get the checked domains for update data from settings."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount3 += 1
        ...
        If intErrorMessage = 4 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "There was an error reading Username and or Password in settings."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount4 += 1
        ...
        If intErrorMessage = 5 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - File Read Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We can't edit this file as it contains # or any other character that is not necessary for the main function of teamspeak dns server and we ask you to remove the commented part of the text so we may properly read the file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount5 += 1
        ...
        If intErrorMessage = 6 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - File Path Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not find the file, Please go define it in the file tab."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount6 += 1
        ...
        If intErrorMessage = 7 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Domain Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You have no domains in the ini file, Please add a domain or build a new ini file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount7 += 1
        ...
        If intErrorMessage = 8 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "There was an error get a valid number from time in settings."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount8 += 1
        ...
        If intErrorMessage = 9 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - File Read Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The teamspeak dns file has not been properly formatted to work, Please revise the file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount9 += 1
        ...
        If intErrorMessage = 10 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Current User Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You are curently login and cant not update more than 10 dns at a time."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount10 += 1
        ...
        If intErrorMessage = 11 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Internet Connection Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not connect to the internet to get the ip address, Please try again at a later time."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount11 += 1
        ...
        If intErrorMessage = 12 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - File Read Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "This is not Teamspeak's DNS Settings File, Please try again."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount12 += 1
        ...
        If intErrorMessage = 13 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Application Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You have not loaded a Teamspeak DNS File, Please load the file before trying to reload."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount13 += 1
        ...
        If intErrorMessage = 14 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Reset Complete"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We have completed the reset all data has been cleaned."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount14 += 1
        ...
        If intErrorMessage = 15 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You have not specified a service name or process file location."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount15 += 1
        ...
        If intErrorMessage = 16 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Restart Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We can't restart a process please just manually stop and start the process, sorry for the inconvenience but at least this only affects manual restart."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount16 += 1
        ...
        If intErrorMessage = 17 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not use access to get a valid number in the settings file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount17 += 1
        ...
        If intErrorMessage = 18 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not use the service name specified in the settings file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount18 += 1
        ...
        If intErrorMessage = 19 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not use the file specified in the settings file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount19 += 1
        ...
        If intErrorMessage = 20 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Process Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We failed to start that process, Please try again later."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount20 += 1
        ...
        If intErrorMessage = 21 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Process Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We failed to stop that process, Please try again later."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount21 += 1
        ...
        If intErrorMessage = 22 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We failed to restart that service, Please try again later."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
        ...
        If intErrorMessage = 23 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We failed to start that service, Please try again later."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount23 += 1
        ...
        If intErrorMessage = 24 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We failed to stop that service, Please try again later."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount24 += 1
        ...
        If intErrorMessage = 25 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Process Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not use this file, Please try again or pick a new file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount25 += 1
        ...
        If intErrorMessage = 26 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not use this service name, Please try again or pick a new service name."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount26 += 1
        ...
        If intErrorMessage = 27 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Reset Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Not much has changed so there is no need for a reset, Please load a file then you may reset the data."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount27 += 1
        ...
        If intErrorMessage = 28 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Settings Saved"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Your setting have been saved to the settings file."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount28 += 1
        ...
        If intErrorMessage = 29 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Write Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You have not given a valid file to write too, Please go define the file and try again."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount29 += 1
        ...
        If intErrorMessage = 30 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Exit Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We ask you wait till the operation is completed."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount30 += 1
        ...
        If intErrorMessage = 31 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Startup Message"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You will only see the same message 3 times before the message stops popping up."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount31 += 1
        ...
        If intErrorMessage = 32 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Guest User Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "You can't change the timer unless you login in to an account."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount32 += 1
        ...
        If intErrorMessage = 33 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Wipe Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "No file found to wipe clean, Please find the file and try again."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount33 += 1
        ...
        If intErrorMessage = 34 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Data Reloaded"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We have reloaded all data successfully."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount34 += 1
        ...
        If intErrorMessage = 35 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Teamspeak DNS Started"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The service or process has successfully started."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount35 += 1
        ...
        If intErrorMessage = 36 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Teamspeak DNS Stoped"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The service or process has successfully stoped."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount36 += 1
        ...
        If intErrorMessage = 37 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Teamspeak DNS Restarted"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The service has successfully restarted."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount37 += 1
        ...
        If intErrorMessage = 38 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Teamspeak DNS File Updated"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "Teamspeak dns file has been updated."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount38 += 1
        ...
        If intErrorMessage = 39 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Domain Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We can only support up to 20 domains, Continue at your own discretion."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount39 += 1
        ...
        If intErrorMessage = 40 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Startup Control"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The registry has been updated so Teamspeak Assistant Tool Application will start up with your computer."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount40 += 1
        ...
        If intErrorMessage = 41 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Info
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Startup Control"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The registry has been updated so the Teamspeak Assistant Tool Application does not start with your computer."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount41 += 1
        ...
        If intErrorMessage = 42 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Startup Control Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "No registry value of the Teamspeak Assistant Tool Application was found."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount42 += 1
        ...
        If intErrorMessage = 43 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Startup Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The service is already running, please stop the service before asking to start it again."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount43 += 1
        ...
        If intErrorMessage = 44 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Stoping Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The service has already been stoped, please start the service before asking to stop it again."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount44 += 1
        ...
        If intErrorMessage = 45 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Restarting Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "To restart a service you need to have the service running."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount45 += 1
        ...
        If intErrorMessage = 46 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Start in Tray Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "We could not get a valid integer for the start in tray variable."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount46 += 1
        ...
        If intErrorMessage = 47 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Start in Tray Error"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The start in tray variable has exceeded it allowed integer limit."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount47 += 1
        ...
        If intErrorMessage = 48 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Warning
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Service Does Not Exists"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The Service Name you provided does not exists in this machine."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount48 += 1
        ...
        If intErrorMessage = 49 Then
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.Warning
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - No Need to wipe settings file"
            My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = "The settings file has no user saved setting on it yet."
            My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
            intErrorCount49 += 1
    ...
    Public Sub Message()
        ...
        If intAccount = 0 Then
            My.Forms.frmTeamspeakMain.mnuLogo.Image = My.Resources.teamspeak
            My.Forms.frmTeamspeakMain.lblSpace.Text = "    " + "Date/Time: " + strLabelTime + "    "
            My.Forms.frmTeamspeakMain.lblSpace.ForeColor = Color.White
            My.Forms.frmTeamspeakMain.lblMessage.Text = "Welcome Guest User :-)"
            My.Forms.frmTeamspeakMain.lblMessage.ForeColor = Color.White
        End If
        If intAccount = 1 Then
            My.Forms.frmTeamspeakMain.mnuLogo.Image = My.Resources.logo
            My.Forms.frmTeamspeakMain.lblSpace.Text = "   " + "Date/Time: " + strLabelTime + " "
            My.Forms.frmTeamspeakMain.lblSpace.ForeColor = Color.White
            My.Forms.frmTeamspeakMain.lblMessage.Text = "Welcome xKiller Admin :-)"
            My.Forms.frmTeamspeakMain.lblMessage.ForeColor = Color.White
        End If
        If intAccount = 2 Then
            ...
            My.Forms.frmTeamspeakMain.lblSpace.Text = "    " + "Date/Time: " + strLabelTime + "   "
            My.Forms.frmTeamspeakMain.lblSpace.ForeColor = Color.White
            My.Forms.frmTeamspeakMain.lblMessage.Text = "Welcome xKiller User :-)"
            My.Forms.frmTeamspeakMain.lblMessage.ForeColor = Color.White
        End If
        If intAccount = 3 Then
            ...
            My.Forms.frmTeamspeakMain.lblSpace.Text = "   " + "Date/Time: " + strLabelTime + "  "
            My.Forms.frmTeamspeakMain.lblSpace.ForeColor = Color.White
            My.Forms.frmTeamspeakMain.lblMessage.Text = "Welcome Trusted User :-)"
            My.Forms.frmTeamspeakMain.lblMessage.ForeColor = Color.White
        End If
    End Sub
    ...
    Public Sub ErrorReset()
        ...
        If File.Exists(strFile) Then
            intMessageError = 1
            My.Forms.frmTeamspeakMain.tmrTeamspeak.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain0.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain1.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain2.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain3.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain4.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain5.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain6.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain7.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain8.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain9.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain10.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain11.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain12.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain13.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain14.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain15.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain16.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain17.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain18.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain19.Checked = False
            My.Forms.frmTeamspeakMain.chkDomain0.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain1.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain2.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain3.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain4.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain5.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain6.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain7.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain8.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain9.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain10.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain11.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain12.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain13.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain14.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain15.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain16.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain17.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain18.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain19.Enabled = False
            My.Forms.frmTeamspeakMain.chkDomain0.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain1.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain2.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain3.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain4.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain5.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain6.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain7.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain8.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain9.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain10.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain11.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain12.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain13.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain14.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain15.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain16.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain17.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain18.Text = "Not Available"
            My.Forms.frmTeamspeakMain.chkDomain19.Text = "Not Available"
    ...
    Public Sub TimeChange()
        ...
        My.Forms.frmTeamspeakMain.psbTeamspeakProgress.Maximum = intFixTime
    End Sub
            ...
            If intSettings = 9 Then
                Try
                    ...
                    If Operators.CompareString(strChecked, "Checked=NULL", False) <> 0 Then
                        ...
                        If intAccount = 0 Then
                            If strSettingsChecked.Contains("chk0") AndAlso My.Forms.frmTeamspeakMain.chkDomain0.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain0.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk1") AndAlso My.Forms.frmTeamspeakMain.chkDomain1.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain1.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk2") AndAlso My.Forms.frmTeamspeakMain.chkDomain2.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain2.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk3") AndAlso My.Forms.frmTeamspeakMain.chkDomain3.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain3.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk4") AndAlso My.Forms.frmTeamspeakMain.chkDomain4.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain4.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk5") AndAlso My.Forms.frmTeamspeakMain.chkDomain5.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain5.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk6") AndAlso My.Forms.frmTeamspeakMain.chkDomain6.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain6.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk7") AndAlso My.Forms.frmTeamspeakMain.chkDomain7.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain7.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk8") AndAlso My.Forms.frmTeamspeakMain.chkDomain8.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain8.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk9") AndAlso My.Forms.frmTeamspeakMain.chkDomain9.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain9.Checked = True
                            End If
                        End If
                        If intAccount > 0 Then
                            If strSettingsChecked.Contains("chk0") AndAlso My.Forms.frmTeamspeakMain.chkDomain0.Enabled Then
                            ...
                            If strSettingsChecked.Contains("chk9") AndAlso My.Forms.frmTeamspeakMain.chkDomain9.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain9.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk10") AndAlso My.Forms.frmTeamspeakMain.chkDomain10.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain10.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk11") AndAlso My.Forms.frmTeamspeakMain.chkDomain11.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain11.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk12") AndAlso My.Forms.frmTeamspeakMain.chkDomain12.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain12.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk13") AndAlso My.Forms.frmTeamspeakMain.chkDomain13.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain13.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk14") AndAlso My.Forms.frmTeamspeakMain.chkDomain14.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain14.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk15") AndAlso My.Forms.frmTeamspeakMain.chkDomain15.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain15.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk16") AndAlso My.Forms.frmTeamspeakMain.chkDomain16.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain16.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk17") AndAlso My.Forms.frmTeamspeakMain.chkDomain17.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain17.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk18") AndAlso My.Forms.frmTeamspeakMain.chkDomain18.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain18.Checked = True
                            End If
                            If strSettingsChecked.Contains("chk19") AndAlso My.Forms.frmTeamspeakMain.chkDomain19.Enabled Then
                                My.Forms.frmTeamspeakMain.chkDomain19.Checked = True
                            End If
                        End If
                    End If
    ...
    Public Sub CheckedDomain()
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(142, 68, 173)
        If My.Forms.frmTeamspeakMain.chkDomain0.Checked Then
            strCheckedDomain = "chk0,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain1.Checked Then
            strCheckedDomain += "chk1,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain2.Checked Then
            strCheckedDomain += "chk2,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain3.Checked Then
            strCheckedDomain += "chk3,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain4.Checked Then
            strCheckedDomain += "chk4,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain5.Checked Then
            strCheckedDomain += "chk5,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain6.Checked Then
            strCheckedDomain += "chk6,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain7.Checked Then
            strCheckedDomain += "chk7,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain8.Checked Then
            strCheckedDomain += "chk8,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain9.Checked Then
            strCheckedDomain += "chk9,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain10.Checked Then
            strCheckedDomain += "chk10,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain11.Checked Then
            strCheckedDomain += "chk11,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain12.Checked Then
            strCheckedDomain += "chk12,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain13.Checked Then
            strCheckedDomain += "chk13,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain14.Checked Then
            strCheckedDomain += "chk14,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain15.Checked Then
            strCheckedDomain += "chk15,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain16.Checked Then
            strCheckedDomain += "chk16,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain17.Checked Then
            strCheckedDomain += "chk17,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain18.Checked Then
            strCheckedDomain += "chk18,"
        End If
        If My.Forms.frmTeamspeakMain.chkDomain19.Checked Then
    ...
    Public Sub Engine()
        ...
        Else
            ...
            End If
            My.Forms.frmTeamspeakMain.psbTeamspeakProgress.Maximum = intFixTime
            My.Forms.frmTeamspeakMain.tmrTeamspeak.Enabled = True
            If intAccount = 0 Then
                If intDomain > 10 Then
                    intErrorMessage = 10
                    ErrorMessage()
                ...
                Else
                    ...
                    If strDomain0.Contains("=") Then
                        ...
                        If strDomain0.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain0.Text = strDisplay0
                            My.Forms.frmTeamspeakMain.chkDomain0.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain0.Text = strDisplay0
                            My.Forms.frmTeamspeakMain.chkDomain0.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain0, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain1.Contains("=") Then
                        ...
                        If strDomain1.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain1.Text = strDisplay1
                            My.Forms.frmTeamspeakMain.chkDomain1.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain1.Text = strDisplay1
                            My.Forms.frmTeamspeakMain.chkDomain1.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain1, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain2.Contains("=") Then
                        ...
                        If strDomain2.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain2.Text = strDisplay2
                            My.Forms.frmTeamspeakMain.chkDomain2.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain2.Text = strDisplay2
                            My.Forms.frmTeamspeakMain.chkDomain2.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain2, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain3.Contains("=") Then
                        ...
                        If strDomain3.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain3.Text = strDisplay3
                            My.Forms.frmTeamspeakMain.chkDomain3.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain3.Text = strDisplay3
                            My.Forms.frmTeamspeakMain.chkDomain3.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain3, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain4.Contains("=") Then
                        ...
                        If strDomain4.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain4.Text = strDisplay4
                            My.Forms.frmTeamspeakMain.chkDomain4.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain4.Text = strDisplay4
                            My.Forms.frmTeamspeakMain.chkDomain4.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain4, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain5.Contains("=") Then
                        ...
                        If strDomain5.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain5.Text = strDisplay5
                            My.Forms.frmTeamspeakMain.chkDomain5.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain5.Text = strDisplay5
                            My.Forms.frmTeamspeakMain.chkDomain5.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain5, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain6.Contains("=") Then
                        ...
                        If strDomain6.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain6.Text = strDisplay6
                            My.Forms.frmTeamspeakMain.chkDomain6.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain6.Text = strDisplay6
                            My.Forms.frmTeamspeakMain.chkDomain6.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain6, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain7.Contains("=") Then
                        ...
                        If strDomain7.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain7.Text = strDisplay7
                            My.Forms.frmTeamspeakMain.chkDomain7.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain7.Text = strDisplay7
                            My.Forms.frmTeamspeakMain.chkDomain7.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain7, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain8.Contains("=") Then
                        ...
                        If strDomain8.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain8.Text = strDisplay8
                            My.Forms.frmTeamspeakMain.chkDomain8.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain8.Text = strDisplay8
                            My.Forms.frmTeamspeakMain.chkDomain8.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain8, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain9.Contains("=") Then
                        ...
                        If strDomain9.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain9.Text = strDisplay9
                            My.Forms.frmTeamspeakMain.chkDomain9.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain9.Text = strDisplay9
                            My.Forms.frmTeamspeakMain.chkDomain9.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain9, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain10.Contains("=") Then
                        ...
                        If strDomain10.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain10.Text = strDisplay10
                            My.Forms.frmTeamspeakMain.chkDomain10.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain10.Text = strDisplay10
                            My.Forms.frmTeamspeakMain.chkDomain10.Enabled = False
                ...
                Else
                    ...
                    If strDomain11.Contains("=") Then
                        ...
                        If strDomain11.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain11.Text = strDisplay11
                            My.Forms.frmTeamspeakMain.chkDomain11.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain11.Text = strDisplay11
                            My.Forms.frmTeamspeakMain.chkDomain11.Enabled = False
                ...
                Else
                    ...
                    If strDomain12.Contains("=") Then
                        ...
                        If strDomain12.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain12.Text = strDisplay12
                            My.Forms.frmTeamspeakMain.chkDomain12.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain12.Text = strDisplay12
                            My.Forms.frmTeamspeakMain.chkDomain12.Enabled = False
                ...
                Else
                    ...
                    If strDomain13.Contains("=") Then
                        ...
                        If strDomain13.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain13.Text = strDisplay13
                            My.Forms.frmTeamspeakMain.chkDomain13.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain13.Text = strDisplay13
                            My.Forms.frmTeamspeakMain.chkDomain13.Enabled = False
                ...
                Else
                    ...
                    If strDomain14.Contains("=") Then
                        ...
                        If strDomain14.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain14.Text = strDisplay14
                            My.Forms.frmTeamspeakMain.chkDomain14.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain14.Text = strDisplay14
                            My.Forms.frmTeamspeakMain.chkDomain14.Enabled = False
                ...
                Else
                    ...
                    If strDomain15.Contains("=") Then
                        ...
                        If strDomain15.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain15.Text = strDisplay15
                            My.Forms.frmTeamspeakMain.chkDomain15.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain15.Text = strDisplay15
                            My.Forms.frmTeamspeakMain.chkDomain15.Enabled = False
                ...
                Else
                    ...
                    If strDomain16.Contains("=") Then
                        ...
                        If strDomain16.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain16.Text = strDisplay16
                            My.Forms.frmTeamspeakMain.chkDomain16.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain16.Text = strDisplay16
                            My.Forms.frmTeamspeakMain.chkDomain16.Enabled = False
                ...
                Else
                    ...
                    If strDomain17.Contains("=") Then
                        ...
                        If strDomain17.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain17.Text = strDisplay17
                            My.Forms.frmTeamspeakMain.chkDomain17.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain17.Text = strDisplay17
                            My.Forms.frmTeamspeakMain.chkDomain17.Enabled = False
                ...
                Else
                    ...
                    If strDomain18.Contains("=") Then
                        ...
                        If strDomain18.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain18.Text = strDisplay18
                            My.Forms.frmTeamspeakMain.chkDomain18.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain18.Text = strDisplay18
                            My.Forms.frmTeamspeakMain.chkDomain18.Enabled = False
                ...
                Else
                    ...
                    If strDomain19.Contains("=") Then
                        ...
                        If strDomain19.Contains("NORESPONSE") Then
                            My.Forms.frmTeamspeakMain.chkDomain19.Text = strDisplay19
                            My.Forms.frmTeamspeakMain.chkDomain19.Enabled = False
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain19.Text = strDisplay19
                            My.Forms.frmTeamspeakMain.chkDomain19.Enabled = False
            ...
            If intAccount > 0 Then
                ...
                Else
                    ...
                    If strDomain10.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain10.Text = strDisplay10
                            My.Forms.frmTeamspeakMain.chkDomain10.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain10, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain11.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain11.Text = strDisplay11
                            My.Forms.frmTeamspeakMain.chkDomain11.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain11, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain12.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain12.Text = strDisplay12
                            My.Forms.frmTeamspeakMain.chkDomain12.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain12, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain13.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain13.Text = strDisplay13
                            My.Forms.frmTeamspeakMain.chkDomain13.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain13, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain14.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain14.Text = strDisplay14
                            My.Forms.frmTeamspeakMain.chkDomain14.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain14, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain15.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain15.Text = strDisplay15
                            My.Forms.frmTeamspeakMain.chkDomain15.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain15, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain16.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain16.Text = strDisplay16
                            My.Forms.frmTeamspeakMain.chkDomain16.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain16, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain17.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain17.Text = strDisplay17
                            My.Forms.frmTeamspeakMain.chkDomain17.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain17, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain18.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain18.Text = strDisplay18
                            My.Forms.frmTeamspeakMain.chkDomain18.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain18, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
                ...
                Else
                    ...
                    If strDomain19.Contains("=") Then
                        ...
                        Else
                            My.Forms.frmTeamspeakMain.chkDomain19.Text = strDisplay19
                            My.Forms.frmTeamspeakMain.chkDomain19.Enabled = True
                        End If
                    ElseIf Operators.CompareString(strDomain19, "", False) <> 0 Then
                        intErrorMessage = 9
                        ErrorMessage()
    ...
    Public Sub IPAddress()
        ...
        Try
            ...
            My.Forms.frmTeamspeakMain.mnuIpDisplay.Image = My.Resources.online
            My.Forms.frmTeamspeakMain.mnuIpDisplay.Text = strExternalIP
        Catch exIPAddress As Exception
            Dim exErrorData As Exception = exIPAddress
            My.Forms.frmTeamspeakMain.mnuIpDisplay.Image = My.Resources.offline
            My.Forms.frmTeamspeakMain.mnuIpDisplay.Text = "Not Available"
    ...
    Public Sub Open()
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(41, 128, 185)
        If My.Forms.frmTeamspeakMain.ofdTeamspeak.ShowDialog() = DialogResult.OK Then
            If Not strFile.Contains("tsdns_settings.ini") Then
                intErrorMessage = 12
                ErrorMessage()
                intErrorMessage = 0
            Else
                strFile = My.Forms.frmTeamspeakMain.ofdTeamspeak.FileName
                Startup()
            End If
        End If
        My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(39, 174, 96)
    ...
    Public Sub DiagnosticsLoad()
        If intDiagnosticsClick = 1 Then
            My.Forms.frmTeamspeakMain.mnuErrorMessageControl.Text = "Disable &Diagnostics"
            blnErrorMessage = True
        Else
            blnErrorMessage = False
        End If
        If intDiagnosticsClick = 2 Then
            My.Forms.frmTeamspeakMain.mnuErrorMessageControl.Text = "Enable &Diagnostics"
            intDiagnosticsClick = 0
        End If
        If blnErrorMessage Then
            If Operators.CompareString(strDiagnostics0, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics0
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics1, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics1
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics2, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics2
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics3, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics3
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics4, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics4
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics5, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics5
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics6, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics6
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics7, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics7
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics8, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics8
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics9, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics9
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics10, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics10
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics11, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics11
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics12, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics12
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics13, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics13
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics14, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics14
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics15, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics15
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics16, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics16
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics17, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics17
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics18, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics18
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics19, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics19
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
            ...
            If Operators.CompareString(strDiagnostics20, String.Empty, False) <> 0 Then
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipIcon = ToolTipIcon.[Error]
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipTitle = "xKiller Teamspeak Assistant Tool - Diagnostics Message"
                My.Forms.frmTeamspeakMain.nicTeamspeak.BalloonTipText = strDiagnostics20
                My.Forms.frmTeamspeakMain.nicTeamspeak.ShowBalloonTip(50000)
                My.Forms.frmTeamspeakMain.stbTeamspeak.BackColor = Color.FromArgb(210, 82, 127)
